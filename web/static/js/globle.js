...
/* feature product */
    ...
    var owl = $("#latest-trending-products");
    owl.owlCarousel({
       ...
       // Custom Navigation Events
      $("#latest-trending-next").click(function(){
        owl.trigger('owl.next');
      })
      $("#latest-trending-prev").click(function(){
        owl.trigger('owl.prev');
      }) 
      
    var owl2 = $("#best-selling-products");
    owl2.owlCarousel({
          items : 4, //10 items above 1000px browser width
          itemsDesktop : [1000,4], //5 items between 1000px and 901px
          itemsDesktopSmall : [900,2], // betweem 900px and 601px
    ...
    owl3.owlCarousel({
       ...
       // Custom Navigation Events
      $("#best-offer-next").click(function(){
        owl3.trigger('owl.next');
      })
      $("#best-offer-prev").click(function(){
