    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm text-center">
        <div class="card-body">
          ...
          <a href="museumManage.jsp" class="btn btn-primary">进入管理</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm text-center">
        <div class="card-body">
          ...
          <a href="souvenirManage.jsp" class="btn btn-success">进入管理</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm text-center">
        <div class="card-body">
          ...
          <a href="newsManage.jsp" class="btn btn-info">进入管理</a>
        </div>
      </div>
    </div>
  </div>
